...
# %% auto 0
__all__ = ['AnnData', 'AnnDatas', 'Graph', 'SeriesLike', 'VAR_GENE_SYMBOL', 'VAR_GENE_IDS', 'VAR_MITO', 'OBS_DOUBLET_SCORES',
           'OBS_PREDICTED_DOUBLETS', 'VAR_HUMAN_TF', 'VAR_MOUSE_TF', 'VAR_HUMAN_ENSEMBLE_ID', 'VAR_MOUSE_ENSEMBLE_ID',
           'LAYER_PRENORM', 'LAYER_DETECTED', 'LAYER_SCALED_NORMALIZED', 'EMB_MAGIC', 'EMB_PCA', 'EMB_PCA_HVG',
           'EMB_PHATE', 'EMB_PHATE_HVG', 'CUTOFF_KIND', 'CUTOFF_SHORTHAND_TO_OBS_KEYS', 'CutoffSpecifications',
           'str_to_cutoff_kind', 'CutoffSpecification']
...
# Type Alias for adata.var field
VAR_MITO: TypeAlias = Literal['mtio']
